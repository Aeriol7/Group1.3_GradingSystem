...
<body style="height: 584px; width:1277px; margin-left: 10px;">
    ...
    <div class="set-grades-container">
        <asp:Label ID="TSetGradesLabel" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="20pt" ForeColor="#983939">Grades</asp:Label>
        ...
        <div class="set-grades-table" style="height: 250px; overflow: auto;" >
            ...
            <asp:GridView ID="gvGrades" runat="server" AllowPaging="True" PageSize="5" OnPageIndexChanging="OnPageIndexChanging" OnRowDataBound="gvGrades_RowDataBound" CellPadding="4" ForeColor="#333333" AllowSorting="True">
        ...
        <asp:DropDownList ID="ddlSortAZ" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSortAZ_SelectedIndexChanged" Width="70px">

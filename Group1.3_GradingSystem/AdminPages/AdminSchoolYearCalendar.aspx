<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSchoolYearCalendar.aspx.cs" Inherits="Group1._3_GradingSystem.AdminPages.AdminSchoolYearCalendar" %>
...
<asp:Image ID="Image9" img src="HomeImages/🦆%20icon%20_calendar_.png"  runat="server" />
            ...
            <asp:Label ID="Label13" runat="server" Text="/  Manage School Year" Font-Size="7pt" ForeColor="#B03E3E"></asp:Label>
            
            <asp:Label ID="Label14" runat="server" ForeColor="#B03E3E" Text="School Year Calendar" Font-Names="Arial" Font-Size="17pt"></asp:Label>

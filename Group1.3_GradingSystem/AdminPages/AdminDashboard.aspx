<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="Group1._3_GradingSystem.AdminPages.AdminDashboard" %>
...
<body style="height: 546px">
    ...
    <form id="form1" runat="server">
        <div style="height: 546px">
            ...
            <asp:Image ID="Image3" img src="DashboardImages/🦆%20icon%20_home_.png" runat="server" />
            <asp:Image ID="Image4" img src="DashboardImages/🦆%20icon%20_dashboard_.png"  runat="server" />
            <asp:Image ID="Image5" img src="DashboardImages/🦆%20icon%20_book_.png"  runat="server" />
            <asp:Image ID="Image6" img src="DashboardImages/🦆%20icon%20_clipboard_.png"  runat="server" />
            <asp:Image ID="Image7" img src="DashboardImages/🦆%20icon%20_people_.png"  runat="server" />
            <asp:Image ID="Image8" img src="DashboardImages/🦆%20icon%20_grid%20three%20up_.png"  runat="server" />
            <asp:Image ID="Image9" img src="DashboardImages/🦆%20icon%20_calendar_.png"  runat="server" />
            <asp:Image ID="Image10" img src="DashboardImages/🦆%20icon%20_data%20transfer%20upload_.png"  runat="server" />
            <asp:Image ID="Image11" img src="DashboardImages/Graphic1.png"  runat="server" />

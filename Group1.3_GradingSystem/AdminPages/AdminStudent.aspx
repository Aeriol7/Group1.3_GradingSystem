...
<body>
    <form id="form2" runat="server">
        ...
        <div class="manage-students" style="height: 559px; width: 966px; top: 85px; left: 304px;">
            ...
            <asp:Button ID="AbtnDelete" runat="server" Text="Delete" Width="96px" Height="29px" OnClick="AbtnDelete_Click" OnClientClick="return confirm('Delete student?');" BackColor="White" ForeColor="#983939" />
            <asp:Button ID="AbtnUpdate" runat="server" Text="Update" Width="96px" OnClick="AbtnUpdate_Click" Height="29px" OnClientClick="return confirm('Update student?');" BackColor="White" ForeColor="#983939" />
